...
[`docs/whatsapp-integration.md`](docs/whatsapp-integration.md). So is the
turn that makes tenants merchants at their own URL root, with its
complexity: [`docs/tenant-as-merchant.md`](docs/tenant-as-merchant.md).
