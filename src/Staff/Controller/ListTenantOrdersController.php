...
use App\Sales\Controller\SalesPresenter;
...
/**
 * GET /api/v1/staff/tenants/{tenantId}/orders[?product=code] — read-only,
 ...
 */
final class ListTenantOrdersController implements RouteHandler
{
    ...
    public function __invoke(ServerRequestInterface $request): ResponseInterface
    {
        ...
        return new JsonResponse(['orders' => array_map(SalesPresenter::order(...), $rows)], 200);
    }
}
