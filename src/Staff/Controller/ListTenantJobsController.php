...
/**
 * GET /api/v1/staff/tenants/{tenantId}/jobs[?product=code] — read-only,
 ...
 */
final class ListTenantJobsController implements RouteHandler
{
    ...
    public function __invoke(ServerRequestInterface $request): ResponseInterface
    {
        ...
        return new JsonResponse(['jobs' => array_map(JobPresenter::one(...), $rows)], 200);
    }
}
