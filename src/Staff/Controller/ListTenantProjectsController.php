...
use App\Project\Controller\ProjectPresenter;
...
/**
 * GET /api/v1/staff/tenants/{tenantId}/projects[?product=code] — read-only,
 ...
 */
final class ListTenantProjectsController implements RouteHandler
{
    ...
    public function __invoke(ServerRequestInterface $request): ResponseInterface
    {
        ...
        return new JsonResponse(['projects' => ProjectPresenter::many($rows)], 200);
    }
}
